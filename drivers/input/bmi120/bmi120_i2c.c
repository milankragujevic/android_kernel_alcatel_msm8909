...
/*! @defgroup bmi120_i2c_src
 *  @brief bmi120 i2c driver module
 @{*/
		...
		const struct i2c_device_id *id)
{
		...
		dev_info(&client->dev, "BMI120 i2c function probe entrance");
...
static const struct of_device_id bmi120_of_match[] = {
	{ .compatible = "bosch-sensortec,bmi120", },
	{ .compatible = "bmi120", },
	{ .compatible = "bosch, bmi120", },
	{ }
};
MODULE_DEVICE_TABLE(of, bmi120_of_match);

static struct i2c_driver bmi_i2c_driver = {
	.driver = {
		.owner = THIS_MODULE,
		.name = SENSOR_NAME,
		.of_match_table = bmi120_of_match,
	},
