...
#define HIMAX_DRIVER_VER "0.1.4.0"
...
struct himax_ts_data {
	bool suspended;
	bool resume_in_workqueue;//add by weigeng.huang for resume in workqueue
	...
	struct work_struct fb_notify_work;//add by weigeng.huang for resume in workqueue
};
...
static struct proc_dir_entry *himax_proc_reset_file 		= NULL;
	...
	#define HIMAX_PROC_FORCE_UPDATE_FILE "force_update"
	static struct proc_dir_entry *himax_proc_force_update_file = NULL;
...
static const struct i2c_device_id himax852xes_ts_id[] = {{"HIMAX852xes_NAME", 1}, {}};
