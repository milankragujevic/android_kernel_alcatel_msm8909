...
static u8 g_proximity_en = 0;
	...
	static unsigned char i_CTPM_FW[]=
	{
		...
		//#include "firmware/YEJI_CM231_TCL_C02_2016-01-18_1025.i"
		//#include "firmware/YEJI_CM231_LC_C02_2016-01-24_1025.i"
		#include "firmware/YEJI_CM231_LC_FWe4_11_CF02.i"
	};
#endif
...
static int i_update_FW(void)
{
	...
	struct version_info update_list[] = {{0xe4,0x11,0x02}};
	int list_len = 0;
	int i = 0;
	...
	size_t len, loff_t *pos)
{
	...
	if (ts_data->vendor_sensor_id == 0x22)
	{
		module = "Eachopto";
	}
	else
