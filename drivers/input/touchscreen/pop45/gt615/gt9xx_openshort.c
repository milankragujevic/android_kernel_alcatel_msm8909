...
#define MAX_LIMIT_VALUE_GROUP1 	12000 	// screen max limit
#define MIN_LIMIT_VALUE_GROUP1 	0		// screen min limit
#define MAX_LIMIT_KEY_GROUP1 		2000//2000	// key_val max limit
...
#define CTP_TEST_CFG_GROUP1 {\
	0x00,0xD0,0x02,0x00,0x05,0x05,0x74,0xD1,0x01,0x0F,\
	0x1E,0x0F,0xFF,0xFF,0x03,0x05,0x00,0x00,0x32,0x32,\
	0x00,0x12,0x0B,0x14,0x15,0x1C,0x14,0x8B,0x2B,0x0C,\
	0x3E,0x40,0x43,0x06,0x00,0x02,0x01,0x43,0x43,0x11,\
	0x3C,0x95,0x05,0x01,0x28,0x41,0x12,0x21,0x22,0x01,\
	0x2A,0x32,0x64,0x4A,0x55,0x52,0x07,0x08,0x14,0x04,\
	0x90,0x35,0x00,0x81,0x3D,0x3C,0x75,0x46,0x14,0x69,\
	0x51,0x00,0x60,0x5D,0x00,0x60,0x18,0x10,0x08,0x00,\
	0x80,0x50,0x30,0xFF,0xFF,0x27,0x00,0x00,0x00,0x00,\
	0x00,0x00,0x00,0x00,0x00,0x28,0x00,0x00,0x02,0x00,\
	0x00,0x19,0x00,0x00,0x3C,0x28,0x1E,0x1E,0x00,0x02,\
	0x14,0x14,0x18,0x16,0x14,0x12,0x10,0x0E,0x0C,0x0A,\
	0x08,0x06,0x04,0x02,0xFF,0xFF,0x00,0x00,0x00,0x00,\
	0x00,0x00,0x00,0x00,0x00,0x00,0x10,0x00,0x00,0x04,\
	...
	0x00,0x00,0x00,0x00,0x32,0x32,0x32,0x32,0x3C,0x3C,\
	0x00,0x1E,0x32,0x32,0x32,0x32,0x32,0x14,0x00,0x3C,\
	0x0A,0x32,0x32,0x32,0x32,0x00,0x00,0x00,0x00,0x00,\
...
#define MAX_LIMIT_VALUE_GROUP3 12000 //3000	// screen max limit
#define MIN_LIMIT_VALUE_GROUP3 800	//1200	// screen min limit
#define MAX_LIMIT_KEY_GROUP3 2000	//2700	// key_val max limit
#define MIN_LIMIT_KEY_GROUP3 0	//1500	// key_val min limit
...
#define CTP_TEST_CFG_GROUP3 {\
	...
	0x00,0x00,0x04,0x17,0x19,0x1E,0x14,0x8A,0x2B,0x0C,\
	0x52,0x54,0x79,0x04,0xFF,0xFE,0x00,0x22,0x33,0x11,\
	0x3A,0x89,0x00,0x00,0x32,0x46,0x00,0x00,0x00,0x00,\
	0x00,0x3C,0x78,0x94,0xC5,0x02,0x07,0x00,0x14,0x04,\
	0xB1,0x40,0x00,0x9A,0x4A,0x00,0x88,0x55,0x00,0x78,\
	0x61,0x00,0x6A,0x70,0x00,0x6A,0x00,0x00,0x00,0x00,\
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
	0x00,0x00,0x00,0x00,0x3C,0x28,0x00,0x00,0x00,0x00,\
	0x00,0x00,0x02,0x04,0x06,0x08,0x0A,0x0C,0x0E,0x10,\
	0x12,0x14,0x16,0x18,0xFF,0xFF,0x00,0x00,0x00,0x00,\
	0x00,0x00,0x00,0x00,0x00,0x00,0x10,0x00,0x00,0x03,\
	0x79,0x04,0x26,0x24,0x22,0x21,0x20,0x1F,0x1E,0x1D,\
	0x1C,0x18,0x16,0x12,0x10,0x0F,0x0C,0x0A,0x08,0x06,\
...
void gtp_open_test_init(struct i2c_client *client)
{
	...
	if (tset_cfg_info_len[sensor_id]!= 0)
	{
		...
		GTP_DEBUG("max_limit_value: %d\n", max_limit_value);
		GTP_DEBUG("min_limit_value: %d\n", min_limit_value);
		GTP_DEBUG("max_limit_key: %d\n", max_limit_key);
		GTP_DEBUG("min_limit_key: %d\n", min_limit_key);
		GTP_DEBUG("uniformity_lmt %d\n", uniformity_lmt);
...
s32 gtp_parse_config(struct i2c_client *client)
{
    ...
    //printk("=============config[%d] = 0x%x\n",0x804E - GT9_REG_CFG_BEG + GTP_ADDR_LENGTH, config[0x804E - GT9_REG_CFG_BEG + GTP_ADDR_LENGTH] );
    if (!have_key)
    {
        GTP_INFO("No key");
        return SUCCESS;
...
s32 gtp_test_sysfs_init(void)
{
    ...
    GTP_INFO("Goodix test sysfs create success!");
    return 0 ;
}
