...
#endif //CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE
*/
// add by ke.li@tcl.com for MP-TEST 2015.10.12 
#include "open_test_RIU1_TXD.h"
#include "open_test_RIU2_TXD.h"
#include "open_test_RIU3_TXD.h"
...
// Modify.
#include "short_test_RIU1_TXD.h"
#include "short_test_RIU2_TXD.h"
#include "short_test_RIU3_TXD.h"
#ifdef CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE  
#include "short_test_RIU4_TXD.h"
#endif //CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE
...
static u16 _DrvMpTestItoTestChooseTpType(void)
{
    ...
    for (i = 0; i < 10; i ++)
    {
        ...
        if (TP_OF_TXD == nTpType || TP_OF_Y == nTpType) // Modify.
        {
            break;
        }
        else if (i < 5)
    ...
    if (TP_OF_TXD == nTpType) // Modify. 
    {
        ...
        {
            _gOpenRIU1 = open_1_TXD;
            _gOpenRIU2 = open_2_TXD;
            _gOpenRIU3 = open_3_TXD;

            _gShort_RIU1 = short_1_TXD;
            _gShort_RIU2 = short_2_TXD;
            _gShort_RIU3 = short_3_TXD;

            _gOpenSubFrameNum1 = NUM_OPEN_1_SENSOR_TXD;
            _gOpenSubFrameNum2 = NUM_OPEN_2_SENSOR_TXD;
            _gOpenSubFrameNum3 = NUM_OPEN_3_SENSOR_TXD;
            _gShortSubFrameNum1 = NUM_SHORT_1_SENSOR_TXD;
            _gShortSubFrameNum2 = NUM_SHORT_2_SENSOR_TXD;
            _gShortSubFrameNum3 = NUM_SHORT_3_SENSOR_TXD;

#ifdef CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE
            _gShort_RIU4 = short_4_TXD;
            _gShortSubFrameNum4 = NUM_SHORT_4_SENSOR_TXD;
#endif //CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE

            _gMAP1 = MAP1_TXD;
            _gMAP2 = MAP2_TXD;
            _gMAP3 = MAP3_TXD;
            _gMAP40_1 = MAP40_1_TXD;
            _gMAP40_2 = MAP40_2_TXD;
            _gMAP41_1 = MAP41_1_TXD;
            _gMAP41_2 = MAP41_2_TXD;

            _gSHORT_MAP1 = SHORT_MAP1_TXD;
            _gSHORT_MAP2 = SHORT_MAP2_TXD;
            _gSHORT_MAP3 = SHORT_MAP3_TXD;

#ifdef CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE       
            _gMAP40_3 = MAP40_3_TXD;
            _gMAP40_4 = MAP40_4_TXD;
            _gMAP41_3 = MAP41_3_TXD;
            _gMAP41_4 = MAP41_4_TXD;

            _gSHORT_MAP4 = SHORT_MAP4_TXD;
#endif //CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE
 
            _gItoTestKeyNum = NUM_KEY_TXD;
            _gItoTestDummyNum = NUM_DUMMY_TXD;
            _gItoTestTriangleNum = NUM_SENSOR_TXD;
            _gIsEnable2R = ENABLE_2R_TXD;
        }
    }
