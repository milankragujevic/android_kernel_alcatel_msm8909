...
#define LED_GPIO_FLASH_DRIVER_NAME	"camera-led-3721s"
...
int led_3721s_gpio_flash_probe(struct platform_device *pdev)
{
	int rc = 0;
	const char *temp_str;
...
int led_3721s_gpio_flash_remove(struct platform_device *pdev)
{
	struct led_gpio_flash_data *flash_led =
...
static struct platform_driver led_gpio_flash_driver = {
	.probe = led_3721s_gpio_flash_probe,
	.remove = led_3721s_gpio_flash_remove,
	.driver = {
