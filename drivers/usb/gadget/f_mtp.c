...
//[PATCH]modify by qian.zhao to add PTP OS descriptor for [PR-1817475] on 2016/03/15 begin
struct ext_mtp_desc {
...
//[PATCH]modify by qian.zhao to add PTP OS descriptor for [PR-1817475] on 2016/03/15 end
	.header = {
