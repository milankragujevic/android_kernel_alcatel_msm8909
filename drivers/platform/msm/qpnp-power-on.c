...
//add by junfeng.zhou for add timestamp of powerkey begin .
{
		...
		pr_info("%d-%02d-%02d %02d:%02d:%02d Report pwrkey %s event,key_code:%d\n", tm.tm_year + 1900, tm.tm_mon + 1, tm.tm_mday,tm.tm_hour, tm.tm_min, tm.tm_sec,pon_rt_bit & pon_rt_sts ?
